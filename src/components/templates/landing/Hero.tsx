  ...
  return (
    <header className="w-full flex items-center justify-between py-6 px-4 md:px-12">
      ...
      <div className="flex items-center gap-4">
        <Link href="/streamviews" className="hidden md:block text-[#888] hover:text-white transition-colors text-sm font-medium">
          Explore
        </Link>
        <Link href="/dashboard">
  ...
  return (
    <section className="relative min-h-screen">
      ...
      <section className="relative flex flex-col items-center justify-center px-4 md:px-12 pt-12 md:pt-20 pb-16">
        {/* Beta Badge */}
        <div className="mb-6">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1a1a1a] border border-white/[0.07] text-sm text-[#888]">
        ...
        {/* Subtitle */}
        <p className="font-host-grotesk text-lg md:text-xl text-[#888] text-center mb-10 max-w-2xl leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          ...
          <Link href="/streamviews">
            <button className="font-host-grotesk px-8 py-4 bg-[#1a1a1a] text-white font-medium rounded-full border border-white/[0.07] hover:bg-[#242424] transition-all duration-200 text-base">
              See It In Action
            </button>
          </Link>
        </div>
        ...
        <div className="w-full max-w-5xl mx-auto relative">
          ...
          <div className="relative bg-[#0f0f0f] rounded-2xl border border-white/[0.07] overflow-hidden shadow-2xl">
      ...
      <section className="py-20 px-4 md:px-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="font-host-grotesk text-[#888] text-center mb-16 max-w-2xl mx-auto">
            Stop renting your audience. Own your platform, keep your revenue, control your data.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group p-6 rounded-2xl bg-[#0f0f0f] border border-white/[0.07] hover:border-white/[0.15] transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-[#1a1a1a] flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
              ...
              <p className="font-host-grotesk text-[#888] text-sm leading-relaxed">
      ...
      {/* How It Works */}
      <section className="py-20 px-4 md:px-12 border-t border-white/[0.07]">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-funnel-display text-3xl md:text-4xl font-bold text-white text-center mb-4">
            Launch in 3 steps
          </h2>
          <p className="font-host-grotesk text-[#888] text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4">
            ...
            <div className="relative text-center">
              ...
              <p className="font-host-grotesk text-[#888] text-sm">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="p-4 rounded-xl bg-[#0f0f0f] border border-white/[0.07] text-center hover:bg-[#1a1a1a] transition-colors">
      ...
      <section className="py-20 px-4 md:px-12">
        <div className="max-w-3xl mx-auto text-center">
          <div className="p-8 md:p-12 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 border border-white/[0.07]">
            <h2 className="font-funnel-display text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to own your platform?
            </h2>
            <p className="font-host-grotesk text-[#888] mb-8 max-w-lg mx-auto">
            ...
            <p className="font-host-grotesk text-[#555] text-sm mt-4">
